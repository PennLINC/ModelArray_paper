...
idx_repeat_mrtrix <- 1  # +++++++++++++++++++ 1,2,3 or "median"
...
nsubj = 30
roof.num.child = 4
flag_legend_order_reverse = TRUE   # TRUE for legend at bottom in final figure; FALSE for legend at side
...
p_together <- f_modelarray[[1]] + f_compare[[1]] + f_modelarray[[2]] + f_compare[[2]] + plot_layout(heights = unit(c(50,50), c('mm','mm')), widths = unit(c(50,60), c('mm','mm')), guides = 'collect') & theme(legend.position = 'bottom', legend.justification = "left")
...
# p_diffncore_nsubj938 <- patchwork::wrap_plots(f_modelarray, f_compare, ncol = 2) + 
#                             guide_area() +
#                             plot_layout(guides = "collect") 
# p_diffncore <- patchwork::wrap_plots(p_diffncore_nsubj30, p_diffncore_nsubj938, nrow = 2) + 
#                             guide_area() +
#                             plot_layout(guides = "collect") 
...
for (ext_figure in list_ext_figure) {
  ggsave(file.path(main.folder.figures,
       ...
       plot = p_together, device = ext_figure, dpi = 300, width = 140, height = 150, units = "mm")   # 
}
...
ggsave(file.path(main.folder.figures, 
                 paste0("figure_nsubj-diff_ncore-", toString(ncpus),"_ModelArrayLM.jpg") ),
       plot = f_modelarray, device = "jpeg", dpi = 300, width = 7, height = 7, units = "in")  # default size in Rmd is 7x7 inches
